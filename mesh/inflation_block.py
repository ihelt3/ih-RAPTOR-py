...
# dependencies = [
#                   "raptorpy @ file:///Users/isaiahhelt/Documents/01_Academia/Research/00_COMMON/raptorpy",
#                   "matplotlib",
#                   "numpy"
#                ]
# ///
...
# NOTE: requires raptorpy environment: 
...
FIRST_LAYER_THICKNESS = 2e-6  # first layer thickness [m]
DIRECTION = 'y'
...
def main():
    ...
    cwd = os.getcwd()
    # cmd = '~/Documents/01_Academia/Research/00_COMMON/raptorpy/.venv/bin/activate;'
    # cmd = 'uv run ~/Documents/01_Academia/Research/00_COMMON/raptorpy/utilities/create_ERNK.py'
    script = pathlib.Path(
        "/Users/isaiahhelt/Documents/01_Academia/Research/00_COMMON/raptorpy/utilities/create_ERNK.py"
        )
